...
<nav class="text-sm text-gray-600" aria-label="Breadcrumb">
    <ol class="flex items-center space-x-2">
        ...
        <li><span class="mx-1 text-gray-400">/</span></li>
        <li><span class="">Inventory History Return</span></li>
    </ol>
</nav>

<div class="flex items-center justify-between mt-6 mb-4">
    
    <h1 class="text-2xl font-bold">Inventory History Return</h1>
...
<div class="flex flex-col h-full overflow-auto">
    <table id="myTable" class="min-w-full table-auto border-collapse border border-gray-300">
        <thead>
            <tr>
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_history.name&orderdir=<?= $orderby == 'inventory_history.name' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Name
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_history.description&orderdir=<?= $orderby == 'inventory_history.description' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Description
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_history.price&orderdir=<?= $orderby == 'inventory_history.price' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Price
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_history.name&orderdir=<?= $orderby == 'inventory_history.quantity' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Quantity
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_type_name&orderdir=<?= $orderby == 'inventory_type_name' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Inventory Type
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=sub_inventory_type_name&orderdir=<?= $orderby == 'sub_inventory_type_name' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Sub Inventory Type
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=supplier_name&orderdir=<?= $orderby == 'supplier_name' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Supplier
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_history.remarks&orderdir=<?= $orderby == 'inventory_history.remarks' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Remarks
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_history.created_at&orderdir=<?= $orderby == 'inventory_history.created_at' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Created At
                ...
                <th class="sticky top-0 bg-white px-4 py-2 border-b text-left">
                    <a href="?number_per_page=<?= esc($number_per_page) ?>&search=<?= esc($search) ?>&inventory_type=<?=$inventory_type_parse['id']?>&sub_inventory_type=<?=$sub_inventory_type_parse['id']?>&orderby=inventory_history.updated_at&orderdir=<?= $orderby == 'inventory_history.updated_at' && $orderdir == 'asc' ? 'desc' : 'asc' ?>">
                        Updated At
        ...
        <tbody>
            <?php foreach ($inventory_history_return as $record): ?>
                <tr>
...
<div class="flex justify-between items-center mt-4">
    ...
    <div class="flex gap-2">
        <?php if ($currentPage > 1): ?>
            <?php $queryParams['page_inventory_history_return'] = $currentPage - 1; ?>
        ...
        <?php for ($i = $start; $i <= $end; $i++): ?>
            <?php $queryParams['page_inventory_history_return'] = $i; ?>
