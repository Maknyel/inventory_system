...
<head>
	<meta charset="utf-8">
	<title>DR FORM TO DISTRIBUTORS</title>
	<style>
		@page {
			margin-top: 150px;
...
<body>
	...
	<main>
		...
		<table class="fordelivery">
			...
			<tfoot>
				<tr>
					<td colspan="5" class="text-right"><strong>TOTAL DISCOUNTED AMOUNT:</strong></td>
		...
		<table border="0" class="mt-10" style="width:100%; ">
			<tr>
				...
				<td style="text-align:right;">
					<div class="signature">Received Signature</div>
				</td>
			</tr>

			<tr>
				<td style="text-align:left;">
					<div class="signature mt-10">Checked By</div>
				</td>
				<td></td>
			</tr>
